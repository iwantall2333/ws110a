...
router.get("/session", session.initMiddleware(), async (ctx) => {           //只要有用到session 就要加  session.initMiddleware() 而且有些地方要加 為甚麼不知道 
...
console.log('server run at http://localhost:8000/session')
